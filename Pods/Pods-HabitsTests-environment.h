...
// FCOverlay
#define COCOAPODS_POD_AVAILABLE_FCOverlay
#define COCOAPODS_VERSION_MAJOR_FCOverlay 1
#define COCOAPODS_VERSION_MINOR_FCOverlay 0
#define COCOAPODS_VERSION_PATCH_FCOverlay 5

// KIF
#define COCOAPODS_POD_AVAILABLE_KIF
#define COCOAPODS_VERSION_MAJOR_KIF 3
#define COCOAPODS_VERSION_MINOR_KIF 0
#define COCOAPODS_VERSION_PATCH_KIF 6
...
#define COCOAPODS_VERSION_PATCH_KIF_XCTest 6
